...
void ADF4351Driver::SetFrequency(unsigned long frequency) {
...
void ADF4351Driver::SetPhase(float phase_angle) {

}

unsigned long ADF4351Driver::GetFrequency() {
	return current_freq;
}

char ADF4351Driver::GetAmplitude() {
	char amplitude;
	switch (dBm) {
	case 0:
		amplitude = -4;
...
void ADF4351Driver::SetFreq(unsigned long FreqADF4351) {
#ifdef ADF_DEBUG
...
void ADF4351Driver::PrepareDataBuffer(int idx) { // make 4 byte from integer for SPI-Transfer
	byte buf[4];
	for (int i = 0; i < 4; i++) {
...
//
//////////////////////////////// Teil-Subroutine ADF4351 //////////////////////////
void ADF4351Driver::CalculateRegisters(unsigned long freq, unsigned long R[]) {
