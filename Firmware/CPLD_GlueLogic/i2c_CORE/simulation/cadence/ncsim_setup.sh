...
TOP_LEVEL_NAME="i2c_CORE"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="D:/intel_fpga/quartus_lite/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/i2c_CORE_ufm_i2c_0.v" -work ufm_i2c_0 -cdslib ./cds_libs/ufm_i2c_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/i2c_CORE.vhd"                                                                        
fi
