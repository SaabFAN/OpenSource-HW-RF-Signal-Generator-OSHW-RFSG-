...
# ----------------------------------------
# If i2c_CORE is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2019.03.15.16:44:31
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/intel_fpga/quartus_lite/quartus/"
}
...
ensure_lib           ./libraries/ufm_i2c_0/
vmap       ufm_i2c_0 ./libraries/ufm_i2c_0/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/i2c_CORE_ufm_i2c_0.v" -work ufm_i2c_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/i2c_CORE.vhd"                                   
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ufm_i2c_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L maxv_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L maxv $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ufm_i2c_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L maxv_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L maxv $TOP_LEVEL_NAME
}
